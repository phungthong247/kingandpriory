...
class Submitapi extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
		...
		$limit = ($this->_indata->getConfig('instagramsection/instagramgroup/limit')) ? $this->_indata->getConfig('instagramsection/instagramgroup/limit') : 10;
        	...
        	foreach ($result['data'] as $key_d => $val_d) {
        		if(isset($val_d['media_type']) && $val_d['media_type'] == 'IMAGE'){
        			...
        			if(isset($val_d['media_url'])){
        				...
        				$instagrampost->setLocalMediaUrl($img);
        			}
